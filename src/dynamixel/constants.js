...
// Control Table Size (in bytes) for each address
export const CONTROL_TABLE_SIZE = {
  MODEL_NUMBER: 2,
  MODEL_INFORMATION: 4,
  FIRMWARE_VERSION: 1,
  ID: 1,
  ...
  EXTERNAL_PORT_MODE_1: 1,
  EXTERNAL_PORT_MODE_2: 1,
  EXTERNAL_PORT_MODE_3: 1,
  SHUTDOWN: 1,
  TORQUE_ENABLE: 1,
  LED: 1,
...
// Helper function to get control table item by string name
export function getControlTableItem(name) {
  if (typeof name === 'string' && Object.prototype.hasOwnProperty.call(CONTROL_TABLE, name)) {
    return {
      address: CONTROL_TABLE[name],
      size: CONTROL_TABLE_SIZE[name] || 1
    };
  }
  return null;
}
